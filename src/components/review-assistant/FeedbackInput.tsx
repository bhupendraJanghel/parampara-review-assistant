  ...
  return (
    <div className="flex-1 flex flex-col p-6 z-10">
      ...
      <div className="space-y-6 flex-1 flex flex-col">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    selectedDetails.includes(chip)
                      ? "bg-gold-500/20 border border-gold-500/60 text-gold-300 shadow-[0_0_10px_rgba(231,184,92,0.2)]"
        ...
        <div className="glass-card h-40 rounded-3xl p-5 flex flex-col relative group transition-all duration-300 focus-within:border-gold-500/40 focus-within:shadow-[0_8px_32px_rgba(231,184,92,0.1)]">
          <textarea
            ref={textareaRef}
            value={feedback}
